...
@forelse  ($icons as $icon)
                    <div class="col">
                        <div class="d-flex align-items-center flex-column gap-3 theme-icons py-5 cursor-pointer bg-trans-crystal pt-4">
...
@empty
                    <div class="col-12 theme-icons py-3 cursor-pointer rounded border w-100">
                        <h4 class="text-center"><i class="fa fa-exclamation-square pe-5"></i>Nenhuma resultado encontrado, tente novamente.&emsp14;<i class="fa fa-exclamation-square ps-5"></i></h4>
                    </div>
@endforelse
                </div>
                <hr>
