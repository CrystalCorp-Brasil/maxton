                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-7">
                                        <div class="d-flex align-items-center gap-3 mb-5">
                                            <img src="@if($user->image == null){{ asset('images/admin/user.png') }}@else{{ asset($user->image) }}@endif" class="rounded-circle bg-grd-info p-1"  width="60" height="60" alt="{{ $user->username }}">
                                            <div class="">
                                                <p class="mb-0 fw-semibold">Bem vindo</p>
                                                <h4 class="fw-semibold mb-0 fs-4 mb-0">{{ $user->name }}!</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-5">
                                        <div class="welcome-back-img pt-4"><img src="{{ asset('images/corp/welcomeBack.png') }}" height="180" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
