@extends('admin.layouts.layout',['pageActive'=>'dashboard','pageTitle'=>'Dashboard','classBody'=>'pace-done','mainClass'=>'main-wrapper'])
@section('headTitle')Dashboard @endsection
@section('content')
                <div class="row">
