...
@yield('search')
                ...
                <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascrpt:void(0)" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown"><img src="@if($user->image == null){{ asset('images/admin/user.png') }}@else{{ asset($user->image) }}@endif" class="rounded-circle p-1 border" width="45" height="45" alt=""></a>
                        <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                            <a class="dropdown-item  gap-2 py-2" href="javascript:void(0)">
                                <div class="text-center">
                                    <img src="@if($user->image == null){{ asset('images/admin/user.png') }}@else{{ asset($user->image) }}@endif" class="rounded-circle p-1 shadow mb-3" width="90" height="90" alt="">
                                    <h5 class="user-name mb-0 fw-bold text-capitalize">olá, {{ $user->username }}</h5>
                                </div>
                            </a>
