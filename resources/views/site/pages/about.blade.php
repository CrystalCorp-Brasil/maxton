                        ...
                        <div class="col-lg-6 py-5 card">
                            <div class="row h-100 flex-center">
                                <div class="col-lg-10">
                                    ...
                                    <blockquote class="blockquote text-center my-6 border card p-5 px-xl-7 rounded" data-zanim-xs='{"delay":0.1}' data-zanim-trigger="scroll">
                                ...
                                <div class="col-lg-10"><img class="rounded img-fluid" src="{{ asset('images/web/crystalcorp/about-04.jpg') }}" alt="" data-zanim-xs='{"animation":"zoom-in","delay":0.1}' data-zanim-trigger="scroll"/>
                                    <div class="row gx-4 mt-6">
                                        <div class="col-md col-lg-12 col-xl-6 card px-3 py-5">
                                            <div class="overflow-hidden">
