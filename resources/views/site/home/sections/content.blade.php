                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            ...
                            <a class="btn btn-outline-info mt-5 px-3" href="#!">Sobre nós</a>
                        </div>
                    </div>
                </div>
            </section>
            <section class="text-center p-5 overflow-hidden" id="bicycleCta" style="background-image:url({{ asset('images/dev/body-background-3.jpg') }});">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col px-4">
                            <div class="position-relative overflow-hidden rounded">
                                ...
                                <div class="position-relative py-8 py-md-11" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                                    ...
                                    <div data-zanim-xs='{"delay":0.2}'><a class="btn btn-outline-primary border-2 mt-3 px-3" href="#!">aventure-se</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="text-center p-5" id="editorials">
                <div class="container-fluid">
                    <div class="row m-0">
                    </div>
                </div>
