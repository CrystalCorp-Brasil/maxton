                            <div class="row pr-2">
                                <div class="col">
                                    <div>
                                        ...
                                        <div class="mt-4 text-justify">{!! $post->subject !!}</div>
                                        <span class="text-green  mt-3 mr-2">Visualizações: </span><span class="font-secondary ps-1">{{ $post->visits }}</span>
                                    </div>
                                    <hr class="text-white">
                                    <button class="btn btn-a-link-1 text-bold ml-2" onclick="history.back()"><span class="d-inline-block ms-1">&xlarr;</span>&nbsp; Go Back</button>
                                </div>
                            </div>
