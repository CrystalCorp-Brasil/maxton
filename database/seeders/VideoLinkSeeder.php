<?php
    ...
    class VideoLinkSeeder extends Seeder {
        public function run(): void {
            FacadesDB::table('videos_links')->insert([
                [
                    'title'=>'O Plano de Brainiac',
                    'slug'=>'o-plano-de-brainiac',
                    'image'=>'uploads/videos/o-plano-de-brainiac.jpg',
                    'content'=>'Brainiac explicando a origem do Multiverso e expondo seus desejos com sua visita ao planeta Terra.',
                    'tag'=>'Cinematic',
                    ...
                    'content'=>'Você acaba de despertar e com o auxilio de Superman e Oracle sua missão é fugir da nave de Brainiac.',
                    'tag'=>'Walkthrough',
                    ...
                    'content'=>'Wonder Woman analisando a coragem e a importância das ações de Future Lex Luthor.',
                    'tag'=>'Cinematic',
                    ...
                    'content'=>'A trajetória para impedir Brainiac de conquistar o mundo começa agora.',
                    'tag'=>'Walkthrough',
                    ...
                    'content'=>'Descubra o que aconteceu com Zatanna, feiticeira que conjura mágias pronunciando as palavras ao contrário.',
                    'tag'=>'Walkthrough',
                    ...
                    'content'=>'Zatanna está presa e amordaçada dessa forma impedida de usar seus poderes. Cabe a você resgatá-la!',
                    'tag'=>'Walkthrough',
                    ...
                    'content'=>'O que Felix Faust está planejando? Continue sua investigação para localizar Felix Faust.',
                    'tag'=>'Walkthrough',
                    ...
                    'content'=>'Com a localização de Felix Faust, você e Zatanna devem impedir o mago de concluir seu plano.',
                    'tag'=>'Walkthrough',
                    'link'=>'https://www.youtube.com/watch?v=O61ePgvoD5I',
                    'user_id'=>'1',
                    'created_at'=> now()
                    ...
                    'content'=>'Uma breve história sobre a história passada de Felix Faust. Entenda suas motivações.',
                    'tag'=>'Cinematic',
                    ...
                    'content'=>'Com a derrota de Felix Faust Zatanna chama você a delegacia de Chinatown para conversar.',
                    'tag'=>'Walkthrough',
